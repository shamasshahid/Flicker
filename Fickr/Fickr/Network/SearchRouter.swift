...
enum SearchRouter: APIRoutable {
    ...
    private func getQueryParams() -> [URLQueryItem] {
        return [URLQueryItem(name: QueryItemsKeys.method.rawValue, value: QueryItemsParams.searchFunction.rawValue),
